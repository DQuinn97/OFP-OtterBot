...
var ResponseBasedRateLimiter = /** @class */ (function () {
    function ResponseBasedRateLimiter() {
        this._queue = [];
    ...
    ResponseBasedRateLimiter.prototype._runRequestBatch = function (reqSpecs) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var promises, settledPromises, rejectedPromises, now, retryAt, retryAfter, params;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this._parameters) {
                            console.log('remaining', this._parameters.remaining);
                        }
                        console.log('doing', reqSpecs.length, 'queued', this._queue.length);
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 2:
                                        ...
                                        if (!result.ok) {
                                            console.log('resolve but not ok:', result);
                                        }
                                        resolve(result);
                    ...
                    case 1:
                        ...
                        if (rejectedPromises.length) {
                            ...
                            console.log("waiting for " + retryAfter + " because of excess");
                            this._nextBatchTimer = setTimeout(function () {
                                if (_this._parameters) {
                                    _this._parameters.remaining = _this._parameters.limit;
                                }
                                _this._runNextBatch();
                            }, retryAfter);
                        }
                        else {
                            params = settledPromises.map(function (p) { return p.value; })
                            ...
                            if (params) {
                                ...
                                if (params.resetsAt < now || params.remaining > 0) {
                                    ...
                                    console.log("waiting for " + (params.resetsAt - now) + " because of limit reach");
                                    this._nextBatchTimer = setTimeout(function () {
                                        if (_this._parameters) {
                                            _this._parameters.remaining = _this._parameters.limit;
                                        }
